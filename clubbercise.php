    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p><span class="mkchc">#MakeTheChange//</span> <a class="booklink"
                        href="https://bkfitness.co.uk/bookings/zumbafitness.php">Book
                        Clubbercise</a>
            </div>
            </p>
            <div class="col-md-6" style="text-align: center;">
                <img src="images/zumbanew.jpg"
                    style="width: 60%; border: 3px solid #ff0046; margin-bottom: 1.5em;">
            </div>
        </div>
