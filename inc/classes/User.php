...
class User {
	...
	public function removeFriend($user_to_remove) {//remove user as friend
		$logged_in_user = $this->user['username'];
		$query = mysqli_query($this->con, "SELECT friend_array FROM users WHERE username='$user_to_remove'");//select user from database
		$row = mysqli_fetch_array($query);
