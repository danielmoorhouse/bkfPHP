...
<nav class="navbar navbar-expand-lg">
    ...
    <a class="navbar-brand" asp-area="" asp-controller="Product" asp-action="Create"><img src="images/bklogo2.png" width="200px"
            id="logo"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarText">
        ...
        <ul class="navbar-nav ml-auto" style="margin-right: 3%;">
            <a href="#" data-toggle="modal" data-target="#myModal">
                <li class="nav-item"> Log In <i class="fas fa-sign-in-alt"></i></li>
            </a>
            &nbsp; &nbsp; <a href="register.php">
                <li class="nav-item"> Register <i class="fas fa-user-plus"></i></li>
            </a>
        ...
        <div class="modal-content text-center">
            ...
            <div class="modal-body" style="background-color: black; border-bottom: 3px solid purple;">
                <form action="register.php" method="POST">
                    ...
                    <input style="background-color: purple; border: 0; color: white; width: 30%; padding: 1%;" class="reg-btn btn-primary"
                        type="submit" name="login_button" value="Login">
                    <br>
                    <br>
