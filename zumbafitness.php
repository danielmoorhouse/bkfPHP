    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="container page">
                    ...
                    <h1 class="classtitle" style="color: #D8df55; font-size: 50px; margin-top: 3%;">
                        #ZumbaFitness//
        ...
        <div class="row">
            ...
            <div class="col-md-6" style="text-align: center;">
                <img src="images/bazclass.jpg" style="width: 60%; border: 3px solid #ff0046 ;">
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <br>
                <hr class="hrz">
                <p><span class="mkchzf">#MakeTheChange//</span> <a class="booklinkzumba"
                        href="https://bkfitness.co.uk/bookings/zumbafitness.php">Book Zumba
                        Fitness here</a>
            </div>
            </p>
            <div class="col-md-6" style="text-align: center;">
                <img src="images/zumbanew.jpg" style="width: 60%; border: 3px solid #ff0046; margin-bottom: 2.5em;">
            </div>
        </div>
